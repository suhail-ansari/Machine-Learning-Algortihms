		...
		for reg_coeff in reg_coeffs:
			for sgd_decay in sgd_decays:
				for sgd_mom in sgd_moms:
					...
					print('Score for architecture = {0}, lambda = {1}, decay = {2}, momentum = {3}, actfn = {4}: Accuracy={5}, Training Time: {6}s'.format(arch, 
						reg_coeff, sgd_decay,
						sgd_mom, actfn, score[1], (stop - start).total_seconds()))

	print('Best Config: architecture = {0}, lambda = {1}, decay = {2}, momentum = {3}, actfn = {4}, best_acc = {5}'.format(
		best_config[0], best_config[1], best_config[2], 
		best_config[3], best_config[4], best_config[5]))
	return best_config[0], best_config[1], best_config[2], best_config[3], best_config[4], best_config[5]